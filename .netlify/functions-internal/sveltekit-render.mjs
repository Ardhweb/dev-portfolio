	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				endpoint: __memo(() => import('../server/entries/endpoints/accounts/auth/register/_server.js'))
			},
			{
				...
				endpoint: __memo(() => import('../server/entries/endpoints/accounts/dashboard/profile/_server.js'))
			},
			{
				id: "/api/contact",
				pattern: /^\/api\/contact\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/contact/_server.js'))
			},
			{
				id: "/api/data",
				pattern: /^\/api\/data\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/data/_server.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/file_uploading/_server.js'))
			},
			{
				id: "/api/media",
				pattern: /^\/api\/media\/?$/,
				params: [],
				page: null,
				endpoint: __memo(() => import('../server/entries/endpoints/api/media/_server.js'))
			},
			{
				id: "/contact",
				pattern: /^\/contact\/?$/,
